...
export default function Juego() {
  ...
  return (
    <div className="text-white flex flex-col rounded-md my-2 mx-12 py-2 px-12 items-center">
...
function HeaderJuego(props: { data: PublicacionJuego }) {
  return (
    <h1 className="text-center text-4xl my-2 font-extrabold leading-none tracking-tight text-white">
      {props.data.titulo}
    </h1>
  )
}
